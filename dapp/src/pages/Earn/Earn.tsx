...
import CardStake from 'src/components/CardStake'
...
export default function Earn() {
  ...
  return (
    <main className='container max-w-[960px]'>
      <h2 className='mx-auto mt-10 text-center font-[ExtraBold] text-4xl font-normal text-white'>Staking to Earn</h2>
      <CardStake />
      <CardStake />
      {/* Popup */}
      {isModalOpen && (
        <Modal onClose={() => setIsModalOpen(false)}>
          <div className='m-auto w-[600px] rounded-2xl bg-[#151b2c] px-3 py-4'>
            ...
            <h2 className='text-center font-[ExtraBold] text-base font-normal text-white'>Connect Wallet</h2>
